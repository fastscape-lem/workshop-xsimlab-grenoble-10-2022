[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/fastscape-lem/workshop-potsdam-2022-10/main?urlpath=lab)
[![Test notebooks](https://github.com/fastscape-lem/workshop-potsdam-2022-10/workflows/Test%20notebooks/badge.svg)](https://github.com/fastscape-lem/workshop-grenoble-2022-10/actions)

# Workshop on Xarray / Xarray-simlab (Grenoble, 10-2022)

This repository contains a collection of [Jupyter](http://jupyter.org/)
notebooks for a workshop on Xarray and Xarray-simlab given in October
2022 at ISTerre, University Grenoble-Alpes.
...
- [Run on binder](https://mybinder.org/v2/gh/fastscape-lem/workshop-potsdam-2022-10/main?urlpath=lab)
...
container. Replace `short-course-xsimlab` by any other name you want to
